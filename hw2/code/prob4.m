...
% generator pair
% y_7 - y_13 \leq 0
generator_pair_lhs = sparse([1,1], [4, 13], [1, -1], 1, 3*i_cnt + 2*j_cnt);
generator_pair_rhs = 0;
...
[x, f] = intlinprog(...
    ...
    [generator_presence_lhs; power_output_limit_lhs; 
        absolute_power_trans_lhs;generator_in_tile_lhs;generator_pair_lhs],...
    [generator_presence_rhs; power_output_limit_rhs; 
        absolute_power_trans_rhs;generator_in_tile_rhs;generator_pair_rhs],...
